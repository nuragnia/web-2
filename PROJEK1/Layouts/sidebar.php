...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
     <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="dist/img/Nur Agnia.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="#" class="d-block">Nur Agnia</a>
            </div>
        </div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="./?url=penelitian"
                        ...
                        <i class="fas fa-microscope"></i> <!-- Icon untuk Penelitian -->
                ...
                <li class="nav-item">
                    <a href="./?url=jenis_kegiatan"
                        ...
                        <i class="as fa-clipboard-list"></i> <!-- Icon untuk Jenis Kegiatan -->
