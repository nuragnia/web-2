...
<fieldset class="border border-dark p-3 rounded" style="background-color: lightyellow;">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124146" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="Nama_Lengkap" name="Nama_Lengkap" placeholder="*Nia" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="custom-control custom-radio custom-control-inline">
        <input name="jk" id="jk_1" type="radio" class="custom-control-input" value="laki-laki" required="required" checked> 
